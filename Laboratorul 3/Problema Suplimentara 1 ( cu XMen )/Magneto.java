...
public class Magneto extends XMen {
    public Magneto(List<SuperPuteri> superPuteri, String numePersonaj, int varstaPersonaj) {
    ...
    public String toString() {
        ...
        pentruReturnat.append("Magneto are ").append(varstaPersonaj).append(" ani");
